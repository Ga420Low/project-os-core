...
def _runtime_policy_defaults() -> dict[str, object]:
    return {
        ...
        "execution_policy": {
            ...
            "deep_research_model": "gpt-5",
            "deep_research_scout_model": "gpt-5-mini",
            "deep_research_translation_model": "gpt-5",
            "deep_research_extreme_debug_enabled": False,
            "deep_research_extreme_debug_provider": "anthropic",
            "deep_research_extreme_debug_model": "claude-haiku-4-5-20251001",
