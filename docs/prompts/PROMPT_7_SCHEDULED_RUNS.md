...
```
api-runs execute --mode audit --objective "..." --branch-name codex/audit
api-runs execute --mode design --objective "..." --branch-name codex/design
        ...
        def executor(command, args_dict):
            ...
            if command == "daily_audit":
                ...
                context_pack = services.api_runs.build_context_pack(
                    ...
                    branch_name=f"codex/scheduled-audit-{datetime.now().strftime('%Y%m%d')}",
