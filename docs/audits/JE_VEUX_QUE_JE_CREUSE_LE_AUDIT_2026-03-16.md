# Je Veux Que Je Creuse Le

## Statut

- `draft`
- `research_profile=domain_audit`
- `research_intensity=simple`
...
- je veux que je creuse le problème de fluidité avec ton agent "open claw" en mode recherche approfondie ? Si oui, dis-le moi et je passe en mode focus total sur ce chantier.
