...
- mets toi en mode recherche approfondie  sur notre systeme de conversation avec l'agent open claw se n'est pas du tout fluide j'aimerais parler comme avec par exemple codex app gpt, la tout est compliquer a parler avec lui j'ai l'impression qui comprend rien regarde 
